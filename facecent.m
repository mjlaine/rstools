function x = facecent(n,nrepl,gen)
% keywords: central composite design, experimental design
% call: x = facecent(n,nrepl,gen)
% the function computes a face-centered design matrix 'x'
%
...
x=[x;kron(eye(n,n),[-1;1]);ones(nrepl,1)*zeros(1,n)];
